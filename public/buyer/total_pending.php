...
try {
    // Prepare the SQL query to count the total number of pending orders for the given seller_id
    $sql = "
    ...
    if ($result) {
        ...
        echo json_encode(["status" => "success", "data" => [], "message" => "No pending orders found."]);
    }
