        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('../public/buyer/login.php') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="qrcode" type="file"
                                        class="form-control @error('qrcode') is-invalid @enderror" name="qrcode[]"
                                        value="{{ old('qrcode') }}" autocomplete="qr_code" autofocus>
                                    @error('qrcode')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
