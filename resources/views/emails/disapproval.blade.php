...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1>Account Disapproval</h1>
        </div>

        <!-- Content Section -->
        <div class="content">
            <h2>Hello {{ $user->name . " " . $user->lastname }}</h2>
            <p>Your account has been disapproved!</p>
            <p class="approved-date">Reason: {{ $user->reason_of_disapproval }}</p>

            <p>I'm sorry and try again next time. Thank you.</p>
        </div>
