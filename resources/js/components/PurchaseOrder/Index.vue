                                    ...
                                    <tbody>
                                        <tr v-for="(order, index) in orders" :key="index">
                                            ...
                                            <td>
                                                ...
                                                @click="openImageModal('http://192.168.1.11:8080/buyer/' + order.photo)"
                                                />
                                            </td>
...
export default {
    ...
    closeImageModal() {
        ...
        async getData() {
            ...
            try {
                const response = await fetch(`http://192.168.1.11:8080/buyer/get-orders.php?seller_id=${this.userID}`);
                const data = await response.json();
    ...
    .catch(error => {
        ...
        try {
            const response = await fetch('http://192.168.1.11:8080/buyer/order-cancelled.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
